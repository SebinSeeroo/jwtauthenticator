...
public class SecurityConfig {
    ...
    @Value("${auth.login.endpoint:/api/users/login}")
    private String authLoginEndpoint;

    @Value("${auth.refresh.endpoint::api/refrehtoken/loginWithRefreshToken}")
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.csrf(customizer -> customizer.disable()).
                authorizeHttpRequests(request ->
                        request.requestMatchers(authLoginEndpoint, authRefreshEndpoint).permitAll().
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        provider.setPasswordEncoder(passwordEncryptDecryptService.getPasswordEncoder());
